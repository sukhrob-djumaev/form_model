...
//         () {
//       const formModel = StringFormModel(value: 'initial value');
...
//       const formModel = StringFormModel(value: 'value');
...
//       const validator = RequiredValidator<String>();
//       const formModel = StringFormModel(validators: [validator]);
...
//       const formModel = StringFormModel(value: '');
...
//           .addValidator(const RequiredValidator())
//           .addValidator(const LengthValidator(minLength: 5));
//       final dirtyModel = modelWithValidators.validate();
...
//       const formModel = StringFormModel(value: 'valid value');
//       final modelWithValidators =
//           formModel.addValidator(const LengthValidator(minLength: 5));
//       expect(modelWithValidators.isValid, isTrue);
//     });

//     test('isValid returns false when there are validation errors', () {
//       const formModel = StringFormModel(value: 'val');
//       final modelWithValidators =
//           formModel.addValidator(const LengthValidator(minLength: 5));
//       final dirtyModel = modelWithValidators.validate();
