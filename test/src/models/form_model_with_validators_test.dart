...
void main() {
  group('FormModel with Validators', () {
    test('Initial state of FormModel', () {
      final formModel = FormModel<String>(validators: [RequiredValidator()]);
    ...
    test('FormModel state after setting value', () {
      final formModel = FormModel<String>(validators: [RequiredValidator()]).setValue('test');
    ...
    test('FormModel state after validation', () {
      final formModel = FormModel<String>(validators: [RequiredValidator()]).setValue('test').validate();
      expect(formModel.isDirty, isTrue);
      expect(formModel.isValid, isTrue);
    });

    test('FormModel with failing validation', () {
      final formModel = FormModel<String>(validators: [RequiredValidator()]).setValue(null).validate();
      expect(formModel.isDirty, isTrue);
    ...
    test('FormModel with multiple validators', () {
      final formModel = FormModel<String>(validators: [
        RequiredValidator(),
    ...
    test('FormModel reset', () {
      final formModel = FormModel<String>(validators: [RequiredValidator()]).setValue('test').validate().reset();
      expect(formModel.isDirty, isFalse);
      expect(formModel.value, equals('test'));
      expect(formModel.isValid, isTrue);
    });
    ...
    test('FormModel add validator', () {
      final initialModel = FormModel<String>(validators: [RequiredValidator()]);
      final updatedModel = initialModel.addValidator(StringMinLengthValidator(minLength: 5));
    ...
    test('FormModel remove validator', () {
      final initialValidator = RequiredValidator<String>();
      final initialModel = FormModel<String>(validators: [
        initialValidator,
        StringMinLengthValidator(minLength: 5),
      ]);
    ...
    test('FormModel equality', () {
      final model1 = FormModel<String>(validators: [RequiredValidator()]).setValue('test');
      final model2 = FormModel<String>(validators: [RequiredValidator()]).setValue('test');
      final model3 = FormModel<String>(validators: [RequiredValidator()]).setValue('different');
