...
class PredefinedFormErrorKeyTranslationsFr
  ...
  String translate(PredefinedFormErrorKey errorKey) {
    return switch (errorKey.type) {
      ...
      PredefinedFormErrorType.lengthIsLessThanMin =>
        'La longueur doit être d\'au moins ${errorKey.parameter}.',
      PredefinedFormErrorType.lengthIsMoreThanMax =>
        'La longueur doit être au maximum de ${errorKey.parameter}.',
      PredefinedFormErrorType.lengthIsNotEqual =>
        'La longueur doit être exactement de ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.isNotOnlyText =>
        'Ce champ ne doit contenir que des caractères alphabétiques.',
      ...
      PredefinedFormErrorType.isNotValidDateTime =>
        'Ce champ nécessite une date et une heure valides.',
      PredefinedFormErrorType.dateIsLessThanMinAge =>
        'La valeur doit être d\'au moins ${errorKey.parameter}.',
      PredefinedFormErrorType.dateIsMoreThanMaxAge =>
        'La valeur doit être au maximum de ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.intIsNotValidCreditCard =>
        'Ce n\'est pas un numéro de carte de crédit valide.',
      PredefinedFormErrorType.wordCountIsLessThan =>
        'Le nombre de mots doit être d\'au moins ${errorKey.parameter}.',
      PredefinedFormErrorType.wordCountIsMoreThan =>
        'Le nombre de mots doit être au maximum de ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.stringDoesNotContain =>
        'Le texte doit contenir "${errorKey.parameter}".',
      PredefinedFormErrorType.stringContains =>
        'Le texte ne doit pas contenir "${errorKey.parameter}".',
  ...
  String _formatFileSize(dynamic sizeInBytes) {
    if (sizeInBytes is int) {
      ...
      if (sizeInBytes < 1048576)
        return '${(sizeInBytes / 1024).toStringAsFixed(2)} Ko';
