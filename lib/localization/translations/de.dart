...
class PredefinedFormErrorKeyTranslationsDe
  ...
  String translate(PredefinedFormErrorKey errorKey) {
    return switch (errorKey.type) {
      ...
      PredefinedFormErrorType.lengthIsLessThanMin =>
        'Die Länge muss mindestens ${errorKey.parameter} betragen.',
      PredefinedFormErrorType.lengthIsMoreThanMax =>
        'Die Länge darf höchstens ${errorKey.parameter} betragen.',
      PredefinedFormErrorType.lengthIsNotEqual =>
        'Die Länge muss genau ${errorKey.parameter} betragen.',
      ...
      PredefinedFormErrorType.isNotOnlyText =>
        'Dieses Feld darf nur alphabetische Zeichen enthalten.',
      PredefinedFormErrorType.isNotOnlyNumbers =>
        'Dieses Feld darf nur Zahlen enthalten.',
      PredefinedFormErrorType.isNotValidEmail =>
        'Dieses Feld erfordert eine gültige E-Mail-Adresse.',
      ...
      PredefinedFormErrorType.dateIsLessThanMinAge =>
        'Der Wert muss mindestens ${errorKey.parameter} betragen.',
      PredefinedFormErrorType.dateIsMoreThanMaxAge =>
        'Der Wert darf höchstens ${errorKey.parameter} betragen.',
      ...
      PredefinedFormErrorType.intIsNotValidCreditCard =>
        'Dies ist keine gültige Kreditkartennummer.',
      PredefinedFormErrorType.wordCountIsLessThan =>
        'Die Wortanzahl muss mindestens ${errorKey.parameter} betragen.',
      PredefinedFormErrorType.wordCountIsMoreThan =>
        'Die Wortanzahl darf höchstens ${errorKey.parameter} betragen.',
      ...
      PredefinedFormErrorType.isNotValidIpv6Address =>
        'Dieses Feld erfordert eine gültige IPv6-Adresse.',
      PredefinedFormErrorType.isNotValidUrl =>
        'Dieses Feld erfordert eine gültige URL.',
      PredefinedFormErrorType.isNotEqualTo =>
        'Der Wert muss gleich ${errorKey.parameter} sein.',
      ...
      PredefinedFormErrorType.stringDoesNotContain =>
        'Der Text muss "${errorKey.parameter}" enthalten.',
      PredefinedFormErrorType.stringContains =>
        'Der Text darf "${errorKey.parameter}" nicht enthalten.',
