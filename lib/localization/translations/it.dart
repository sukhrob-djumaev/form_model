...
class PredefinedFormErrorKeyTranslationsIt
  ...
  String translate(PredefinedFormErrorKey errorKey) {
    return switch (errorKey.type) {
      ...
      PredefinedFormErrorType.lengthIsLessThanMin =>
        'La lunghezza deve essere almeno ${errorKey.parameter}.',
      PredefinedFormErrorType.lengthIsMoreThanMax =>
        'La lunghezza deve essere al massimo ${errorKey.parameter}.',
      PredefinedFormErrorType.lengthIsNotEqual =>
        'La lunghezza deve essere esattamente ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.isNotOnlyText =>
        'Questo campo deve contenere solo caratteri alfabetici.',
      ...
      PredefinedFormErrorType.intIsNotValidCreditCard =>
        'Questo non è un numero di carta di credito valido.',
      ...
      PredefinedFormErrorType.isNotValidIpv6Address =>
        'Questo campo richiede un indirizzo IPv6 valido.',
      PredefinedFormErrorType.isNotValidUrl =>
        'Questo campo richiede un URL valido.',
      PredefinedFormErrorType.isNotEqualTo =>
        'Il valore deve essere uguale a ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.stringDoesNotContain =>
        'L\'input deve contenere "${errorKey.parameter}".',
      PredefinedFormErrorType.stringContains =>
        'L\'input non deve contenere "${errorKey.parameter}".',
  ...
  String _formatFileSize(dynamic sizeInBytes) {
    if (sizeInBytes is int) {
      ...
      if (sizeInBytes < 1048576)
        return ' di ${(sizeInBytes / 1024).toStringAsFixed(2)} KB';
