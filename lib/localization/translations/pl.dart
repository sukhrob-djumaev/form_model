...
class PredefinedFormErrorKeyTranslationsPl
  ...
  String translate(PredefinedFormErrorKey errorKey) {
    return switch (errorKey.type) {
      ...
      PredefinedFormErrorType.lengthIsLessThanMin =>
        'Długość powinna wynosić co najmniej ${errorKey.parameter}.',
      PredefinedFormErrorType.lengthIsMoreThanMax =>
        'Długość nie powinna przekraczać ${errorKey.parameter}.',
      PredefinedFormErrorType.lengthIsNotEqual =>
        'Długość powinna wynosić dokładnie ${errorKey.parameter}.',
      PredefinedFormErrorType.didNotMatchPattern =>
        'Wartość nie pasuje do oczekiwanego wzorca: ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.isNotValidPhoneNumber =>
        'To pole wymaga prawidłowego numeru telefonu.',
      ...
      PredefinedFormErrorType.intIsNotValidCreditCard =>
        'To nie jest prawidłowy numer karty kredytowej.',
      PredefinedFormErrorType.wordCountIsLessThan =>
        'Liczba słów powinna wynosić co najmniej ${errorKey.parameter}.',
      PredefinedFormErrorType.wordCountIsMoreThan =>
        'Liczba słów nie powinna przekraczać ${errorKey.parameter}.',
      ...
      PredefinedFormErrorType.stringDoesNotContain =>
        'Wpis powinien zawierać "${errorKey.parameter}".',
      PredefinedFormErrorType.stringContains =>
        'Wpis nie powinien zawierać "${errorKey.parameter}".',
