...
/// [FormError] with the [ErrorCode.boolShouldBeTrue] code, indicating a validation failure.
///
...
final class BoolTrueValidator implements BaseFormModelValidator<bool?> {
  ...
  /// and `null` is returned. If the [value] is `false`, a [FormError] is returned
  ...
  FormError<bool?>? validate(bool? value) {
    if (value != true) {
      return FormError(code: ErrorCode.boolShouldBeTrue, value: value);
    }
    return null;
  }
}
