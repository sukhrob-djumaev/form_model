...
/// If the value does not match the IPv6 pattern, it returns a [FormModelError] with the
...
final class Ipv6AddressValidator implements FormModelValidator<String?> {
    ...
    if (value != null) {
      ...
      if (!ipv6Pattern.hasMatch(value)) {
        return FormModelError(
            code: ErrorCode.isNotValidIpv6Address, value: value);
      }
    }
    return null;
  }
