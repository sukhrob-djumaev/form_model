...
///
/// The `FormError` class encapsulates details about an error that occurs when
...
class FormError<T> {
  ...
  /// Constructs a new [FormError] instance.
  ///
  ...
  /// Compares two [FormError] instances for equality.
  ///
  /// Returns `true` if both instances have the same error code, value, and parameter.
  /// This method allows for meaningful comparison of [FormError] objects.
  @override
  bool operator ==(covariant FormError<T> other) {
  ...
  /// Generates a hash code for the [FormError] instance.
  ///
  /// The hash code is computed based on the error code, value, and parameter.
  /// This method ensures that [FormError] instances can be used effectively in hash-based collections.
  @override
  int get hashCode => code.hashCode ^ value.hashCode ^ parameter.hashCode ^ customErrorText.hashCode;
}
